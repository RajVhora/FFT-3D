	...
	for (i1 = 0; i1 < n_x; ++i1)
	{
		for (i2 = 0; i2 < n_y; ++i2)
		{
			for (i3 = 0; i3 < n_z; ++i3)
			{
				...
				A11 = A11 + (Ceff[1][1][1][1] + DeltaC[1][1][1][1] * a) * epsstr11 + (Ceff[1][1][2][2] + DeltaC[1][1][2][2] * a) * epsstr22 + (Ceff[1][1][3][3] + DeltaC[1][1][3][3] * a) * epsstr33 + (Ceff[1][1][1][2] + DeltaC[1][1][1][2] * a) * epsstr12 + (Ceff[1][1][2][1] + DeltaC[1][1][2][1] * a) * epsstr12 + (Ceff[1][1][1][3] + DeltaC[1][1][1][3] * a) * epsstr13 + (Ceff[1][1][3][1] + DeltaC[1][1][3][1] * a) * epsstr13 + (Ceff[1][1][2][3] + DeltaC[1][1][2][3] * a) * epsstr23 + (Ceff[1][1][3][2] + DeltaC[1][1][3][2] * a) * epsstr23;

				A22 = A22 + (Ceff[2][2][1][1] + DeltaC[2][2][1][1] * a) * epsstr11 + (Ceff[2][2][2][2] + DeltaC[2][2][2][2] * a) * epsstr22 + (Ceff[2][2][3][3] + DeltaC[2][2][3][3] * a) * epsstr33 + (Ceff[2][2][1][2] + DeltaC[2][2][1][2] * a) * epsstr12 + (Ceff[2][2][2][1] + DeltaC[2][2][2][1] * a) * epsstr12 + (Ceff[2][2][1][3] + DeltaC[2][2][1][3] * a) * epsstr13 + (Ceff[2][2][3][1] + DeltaC[2][2][3][1] * a) * epsstr13 + (Ceff[2][2][2][3] + DeltaC[2][2][2][3] * a) * epsstr23 + (Ceff[2][2][3][2] + DeltaC[2][2][3][2] * a) * epsstr23;

				A33 = A33 + (Ceff[3][3][1][1] + DeltaC[3][3][1][1] * a) * epsstr11 + (Ceff[3][3][2][2] + DeltaC[3][3][2][2] * a) * epsstr22 + (Ceff[3][3][3][3] + DeltaC[3][3][3][3] * a) * epsstr33 + (Ceff[3][3][1][2] + DeltaC[3][3][1][2] * a) * epsstr12 + (Ceff[3][3][2][1] + DeltaC[3][3][2][1] * a) * epsstr12 + (Ceff[3][3][1][3] + DeltaC[3][3][1][3] * a) * epsstr13 + (Ceff[3][3][3][1] + DeltaC[3][3][3][1] * a) * epsstr13 + (Ceff[3][3][2][3] + DeltaC[3][3][2][3] * a) * epsstr23 + (Ceff[3][3][3][2] + DeltaC[3][3][3][2] * a) * epsstr23;

				A12 = A12 + (Ceff[1][2][1][2] + DeltaC[1][2][1][2] * a + Ceff[1][2][2][1] + DeltaC[1][2][2][1] * a) * epsstr12;

				A13 = A13 + (Ceff[1][3][1][3] + DeltaC[1][3][1][3] * a + Ceff[1][3][3][1] + DeltaC[1][3][3][1] * a) * epsstr13;

				A23 = A23 + (Ceff[2][3][2][3] + DeltaC[2][3][2][3] * a + Ceff[2][3][3][2] + DeltaC[2][3][3][2] * a) * epsstr23;
			}
		}
	}
