...
void add_noise(int n_x, int n_y, int n_z, double *comp, double noise_str){
...
if(noise_str != 0.0){ 
	comp[i3 + n_z*(i2+n_y*i1)] = comp[i3 + n_z*(i2+n_y*i1)] + noise;}
}}}
...
for(i2=0; i2<n_y; ++i2){
for(i3=0; i3<n_z; ++i3){
comp[i3 + n_z*(i2+n_y*i1)] = comp[i3 + n_z*(i2+n_y*i1)] - mean_noise; 
}}}
