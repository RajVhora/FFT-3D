...
fprintf(fpw,"%d\n\n",STEPS);
fprintf(fpw,"\n\nn_x,n_y,delta_x,delta_y,kappac,A\n");
fprintf(fpw,"B,P\n");
...
comp = dvector(0,n_x*n_y*n_z-1);
generate_initial_composition_profile(n_x,n_y,n_z,comp);
...
add_noise(n_x,n_y,n_z,comp,noise_str,SNA,NOISEADDER);  

free_dvector(comp,0,n_x*n_y*n_z-1);
